...
namespace QuizITAPI.Services
{
    public class SpeechService
    {
        ...
        public async void RecognizeText(byte[] speech)
        {
            ...
            //                Console.WriteLine(
            //                    $"    Language Understanding JSON: {e.Result.Properties.GetProperty(PropertyId.LanguageUnderstandingServiceResponse_JsonResult)}.");
            //            }
